...
function Header() {
  ...
  return (
    <>
      <header className="bg-body-0 w-full max-h-[60px]">
...
<<<<<<< HEAD
            /><h5 className='text-bground-200 border-2 border-bground-200 px-2 text-xs rounded-full'>Main-Server</h5>
=======
          ...
          <div className="flex items-center justify-end gap-5">
            ...
            <div className="relative" ref={menuRef}>
              <div
                ...
                className="h-6 w-6 mr-1.5 cursor-pointer transition-transform duration-250 hover:rotate-40 text-text-color-600 hover:text-text-color-600">
                <Cog className="w-full h-full" />
              </div>

              {/* dropdown */}
              {showMenu && (
                <div className="absolute right-0 top-full mt-1 w-50 bg-body-0 border border-body-200 rounded-md shadow-lg z-10 text-sm">
                  <ul className="py-1">
                    {authStatus && <li>
                      <button onClick={() => navigate('/feedback')} className="w-full text-left px-4 py-2 hover:bg-body-100">
                        Feedback
                      </button>
                    </li>}
                    {authStatus && <li>
                      <button onClick={() => navigate('/report/null')} className="w-full text-left px-4 py-2 hover:bg-body-100">
                        Report a bug
                      </button>
                    </li>}
                    <li>
                      <button onClick={() => navigate('/termsandprivacy')} className="w-full text-left px-4 py-2 hover:bg-body-100">
                        Terms and conditions
                      </button>
                    </li>
                    {authStatus && <li>
                      <button onClick={logoutUser} className="w-full text-left px-4 py-2 text-text-denger hover:bg-red-50">
                        Logout
                      </button>
                    </li>}
                  </ul>
